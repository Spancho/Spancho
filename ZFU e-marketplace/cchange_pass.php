...
?>
  ...
  $query=mysql_query("select * from farmer where username='$usr'") or die(mysql_error());
  $query2=mysql_query("select * from farmer where username='$usr' and password='$oldp'") or die(mysql_error());
  ...
  mysql_query("update farmer set password='$newp' where username='$usr'") or die(mysql_error());
