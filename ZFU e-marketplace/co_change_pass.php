...
?>
  ...
  $query=mysql_query("select * from companies where username='$usr'") or die(mysql_error());
  $query2=mysql_query("select * from companies where username='$usr' and password='$oldp'") or die(mysql_error());
  ...
  mysql_query("update companies set password='$newp' where username='$usr'") or die(mysql_error());
