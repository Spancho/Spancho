...
<div class="head2">
<div class="link1">
<a href="company.php"><p><u><b>Company Login</b></u></p></a></div>
<div class="link2">
<div class="link1">
<a href="index.php"><p><b><u>Farmer Login</u></b></p></a>
<a href="admin.php"><p><u><b>Admin Login</b></u></p></a></div>
...
include("connection/db_con.php");
		...
		{ 			
			...
			// sending query		
			$result = mysql_query("SELECT * FROM companies WHERE username = '$username' AND password = 
						   '$password'");
...
<tr>
<td colspan="4">
<DIV class="admin"><u>COMPANY</u></DIV>
</td>
</tr>
<tr >
<td rowspan="4">
