  ...
  <header class="home-header"> <!-- header -->
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">          
          <!-- logo-->                       
					<a href="#" title="Home" class="logo pull-left"><img src="img/logo.png " alt="logo"></a>           

          <!-- logo ends -->         
          
          <!-- Menu --> 
           <?php include("companymenu.html"); ?>  
          <!-- Menu ends -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            ...
            <ol class="breadcrumb">
              <li><a href="company1.php">Home</a></li>
              <li><a href="company1.php?page=vproducts.php">Shop</a></li>
              <li class="active"></li>
            </ol>            
          </div>
        </div>
      ...
      <div class="col-sm-3">
        ...
        <div class="r-bg">
          <div class="widget">
            <h4>Categories</h4>
              <ul class="list-1">
                <li><a href="company1.php?page=buyers.php">Buyers</a></li>
                <li><a href="company1.php?page=sellers.php">Sellers</a></li>
          ...
          <div class="widget">
            ...
            <ul class="news-box-ul">
              <li>
                ...
                <li><a href="company1.php?page=reportSales.php">Report_Purchases</a></li>
        <li><a href="company1.php?page=finalisepurchase.php">Cart</a></li>
            ...
            <div class="item">
              <div class="related-item-container">
                ...
                <div class="related-item-content">
                  ...
                  <a href="company1.php?page=product.php &&id=<?php echo $fetch['id']; ?>" class="btn btn-default btn-sm" role="button">Add to cart</a>
                </div>                          
              </div>
            </div>
            <?php
