...
<head>
  ...
  <link href="css/bootstrap.min.css" rel="stylesheet" media="screen" />
    <!-- Chat style -->
  <link href="css/chatstylz.css" rel="stylesheet" media="screen" />
  ...
  <!-- Modernizr js -->        
    ...
    <style type="text/css">
body{
background-image: url(images/strawbry001LK.jpg);
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            ...
            <ol class="breadcrumb">
              <li><a href="farmer.php?page=farmer.php">Home</a></li>
              <li><a href="farmer.php?page=vproducts.php.php">Shop</a></li>
              <li class="active"></li>
            </ol>            
          </div>
        </div>
      ...
      <div class="col-sm-3">
        ...
        <div class="r-bg">
          <div class="widget">
            <h4>Categories</h4>
              <ul class="list-1">
                <li><a href="farmer.php?page=buyers.php">Buyers</a></li>
                <li><a href="farmer.php?page=sellers.php">Sellers</a></li>
          ...
          <div class="widget">
            ...
            <ul class="news-box-ul">
              <li>
                ...
                <li><a href="farmer.php?page=reportSales.php">Report_Purchases</a></li>
  <li><a href="farmer.php?page=finalisepurchase.php">Cart</a></li>
            ...
            <div class="item">
              <div class="related-item-container">
                ...
                <div class="related-item-content">
                  ...
                  <a href="farmer.php?page=product.php && id=<?php echo $fetch['id']; ?>" class="btn btn-default btn-sm" role="button">Add to cart</a>
                </div>                          
              </div>
            </div>
            <?php
