...
$query=mysql_query("SELECT * FROM forum  ORDER BY id") or die(mysql_error());
?>
  ...
  <table width="100%" border="0" bgcolor="#FFFFFF" align="center" cellspacing="0">
    ...
    <tr bgcolor="#FF8C1A">
      ...
      <td width="55%" bgcolor="#CCCCCC" class="style7"><? echo $fetch['usr']; ?></td>
