<?php 
	...
	if(isset($_GET['del'])){
		$dbManager->doQuery("delete from cellphone where id = ".$_GET['del']);
		$dbManager->redirect("index.php?page=get_cellphone.php");
	}
	...
	$x = 0;
     ...
     <script language="javascript">
	 	function loadEdit(id){
			location = 'index.php?page=save_cellphone.php&id='+id;
		}
		
		function del(id){
			if(confirm('Are you sure you want to delete this record?')){
				location = 'index.php?page=cellphone.php&del='+id;
			}
		}
	 </script>
